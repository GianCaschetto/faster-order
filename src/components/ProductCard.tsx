...
function ProductCard({ product, addToCart }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className="w-full md:w-3/5 bg-white flex flex-col justify-between items-start space-y-2 p-3">
      ...
      <div className="w-full md:w-2/5 bg-white grid place-items-center ">
        <img
          src={imageUrl}
